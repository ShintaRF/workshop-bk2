                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('jadwalperiksa.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="hari">Status</label>
                                            <select class="form-control" id="hari" name="status" required>
                                                <option value="Senin">Aktif</option>
                                                <option value="Selasa">Tidak Aktif</option>
                                            </select>
                                        </div>
                                        ...
                                        <form id="editForm"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="status" name="status" required>
                                                    <option value="Aktif"
                                                        {{ $jadwal->status == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                                    <option value="Tidak Aktif"
                                                        {{ $jadwal->status == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                                </select>
                                            </div>
                                    </div>
                                    <div class="modal-footer">
